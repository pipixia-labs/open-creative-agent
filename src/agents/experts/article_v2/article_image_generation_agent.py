...
async def nano_banana_image_generation_tool(
    ...
    try:
        ...
        llm = LlmAgent(
            name="article_image_generation_nano_banana",
...
class ArticleImageGenerationAgent(BaseAgent):
    """Generate illustration assets for mixed text-and-image articles."""
    ...
    async def _run_async_impl(self, ctx: InvocationContext) -> AsyncGenerator[Event, None]:
        ...
        # logger.info(draft_results)
        if 'reference_image_name' not in current_parameters and 'article_image_to_generate' not in draft_results:
        ...
        if parallel_mode:
            ...
            results = await nano_banana_image_generation_tool(ctx, img_obj, prompt_list, aspect_ratio=aspect_ratio, resolution="2K")
